...
// Hash of the grammar file: A6474FFD356BA64830D2E84BF6E91BA559AB29154FB649C7BA83F4F7175DEC93
    ...
    mod SahaStatements_impl {
        ...
        pub fn parse<'a>(
            ...
            ChoiceHelper::new(state)
                ...
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
                        .and_then(|ParseOk { state, .. }| parse_UnicodeSpace(state, tracer, cache))
                        .map_inner(Parsed__override::UnicodeSpace)
                })
                .choice(|state| {
                    parse_Whitespace(state, tracer, cache)
