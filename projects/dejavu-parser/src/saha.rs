...
// Hash of the grammar file: B3F252DEE4BFCBE4824086B33EBFC72D6FC5EB43C2D903E517935B492A1D701B
...
mod peginator_generated {
    ...
    mod SlotIf_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::SlotIf {
                start: r.start,
                body: r.body,
                else_if: r.else_if,
                r#else: r.r#else,
    ...
    mod SlotElse_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state, tracer, cache)?.map(|r| super::SlotElse { left: r.left, right: r.right, body: r.body });
            Ok(result)
        }
    }
    #[inline]
    ...
    mod SlotFor_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::SlotFor {
                start: r.start,
                body: r.body,
                r#else: r.r#else,
                end: r.end,
