// This file was generated by Peginator v0.6.0 built at 1669780668
// CRC-32/ISO-HDLC of the grammar file: 8870e1d8
...
mod peginator_generated {
    ...
    pub(super) fn parse_StringLiteral<'a, TT: ParseTracer>(
        ...
        let result = {
            let result = StringLiteral_impl::parse(state, global)?.map(|r| super::StringLiteral { body: r });
            Ok(result)
        };
        global.tracer.print_trace_result(&result);
        result
