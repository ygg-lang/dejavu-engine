...
// Hash of the grammar file: C12BF6F197EED3A75EE3676B32894ACEDE21C140CECCDB1703880A13EC43F6BD
...
mod peginator_generated {
    ...
    mod TermNode_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result =
                parse(state, tracer, cache)?.map(|r| super::TermNode { prefix: r.prefix, term: r.term, suffix: r.suffix });
            Ok(result)
        }
    }
    #[inline]
    ...
    pub(super) fn parse_Prefix<'a>(
        ...
        tracer.run_traced("Prefix", state, |state, tracer| Prefix_impl::rule_parser(state, tracer, cache))
    }
    mod InfixOp_impl {
        use super::*;
