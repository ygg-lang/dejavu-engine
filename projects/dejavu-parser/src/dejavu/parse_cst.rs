...
fn parse_element(state: Input) -> Output {
    state.rule(DejavuRule::Element, |s| Err(s))
}
#[inline]
...
fn parse_text_element(state: Input) -> Output {
    state.rule(DejavuRule::TextElement, |s| Err(s))
}
#[inline]
...
fn parse_space_control(state: Input) -> Output {
    state.rule(DejavuRule::SpaceControl, |s| Err(s))
}
#[inline]
...
fn parse_pattern(state: Input) -> Output {
    state.rule(DejavuRule::Pattern, |s| Err(s))
}
#[inline]
...
fn parse_infix(state: Input) -> Output {
    state.rule(DejavuRule::Infix, |s| Err(s))
}
#[inline]
...
fn parse_prefix(state: Input) -> Output {
    state.rule(DejavuRule::Prefix, |s| Err(s))
}
#[inline]
fn parse_suffix(state: Input) -> Output {
    state.rule(DejavuRule::Suffix, |s| Err(s))
}
#[inline]
fn parse_atomic(state: Input) -> Output {
    state.rule(DejavuRule::Atomic, |s| Err(s))
}
#[inline]
fn parse_string(state: Input) -> Output {
    state.rule(DejavuRule::String, |s| Err(s))
}
#[inline]
fn parse_number(state: Input) -> Output {
    state.rule(DejavuRule::Number, |s| Err(s))
}
#[inline]
...
fn parse_boolean(state: Input) -> Output {
    state.rule(DejavuRule::Boolean, |s| Err(s))
}
#[inline]
